...
// Dynamic import to ensure dotenv runs BEFORE importing the module
const { createClient } = await import('@supabase/supabase-js')
const { loadAiConfig } = await import('../src/lib/ai/config.js')
const { buildConversationContext } = await import('../src/lib/ai/context.js')
const { retrieveKnowledge } = await import('../src/lib/ai/knowledge.js')
const { buildSystemPrompt } = await import('../src/lib/ai/defaults.js')
const { generateReply } = await import('../src/lib/ai/generate.js')
const { latestUserMessage } = await import('../src/lib/ai/query.js')
