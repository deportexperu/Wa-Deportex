...
/** 100 MB — high-capacity media limit for WhatsApp Cloud / YCloud uploads. */
export const MEDIA_MAX_BYTES = 100 * 1024 * 1024;

/**
 * Per-kind upload ceilings matching WhatsApp Cloud & YCloud API specifications.
 * Images cap at 16 MB, videos & documents up to 100 MB, audio up to 64 MB.
 */
